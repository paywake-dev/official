...
const slider = (obj) => {
  ...
  let returns = Math.min(((Math.floor(deposit * ((historic / 100) + 1) * 100) / 100)) - 0.01, deposit + 0.01)
  if (IS_2X) {
    returns = Math.min(((Math.floor(deposit * (((historic / 100) * 2) + 1) * 100) / 100)) - 0.01, deposit + 0.01);
  }
